...
function start_location_checker.check(
  ...
  assert_equal(actual_map_id, "bugs/819_destination_starting_location_mode/" .. expected_map_id_relative)
  assert_equal(actual_destination_name, expected_destination_name)
end
